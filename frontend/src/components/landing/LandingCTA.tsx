...
export function LandingCTA() {
  ...
  const footerFacts = [
    { label: t('landingCta.footerFacts.0.label'), value: t('landingCta.footerFacts.0.value') },
    { label: t('landingCta.footerFacts.1.label'), value: t('landingCta.footerFacts.1.value') },
    { label: t('landingCta.footerFacts.2.label'), value: t('landingCta.footerFacts.2.value') },
    { label: t('landingCta.footerFacts.3.label'), value: t('landingCta.footerFacts.3.value') },
  ];
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 md:px-10">
        <div className="grid gap-8 border-b border-landing-paper/10 pb-12 md:grid-cols-12">
          <div className="md:col-span-3">
            <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-landing-signal">{t('landingCta.eyebrow')}</p>
          </div>
          <div className="md:col-span-9">
            <span className="font-mono text-[11px] uppercase tracking-[0.18em] text-landing-paper/50">
              {t('landingCta.subtitle')}
            </span>
          </div>
        </div>
        ...
        >
          {t('landingCta.titleStart')} <br />
          <em className="italic text-landing-paper/60">{t('landingCta.titleEmphasis')}</em> {t('landingCta.titleEnd')}
        </motion.h2>

        <div className="mt-16 grid gap-12 md:grid-cols-12">
          <div className="md:col-span-6">
            <p className="text-pretty text-lg leading-relaxed text-landing-paper/70">{t('landingCta.description')}</p>
          </div>
